...
!(async () => {
    ...
    .finally(() => $.done())
//查询好友列表
function friendlist(jc_cookie1,timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://ant.xunsl.com/WebApi/ShareSignNew/getFriendFinalList?'+jc_cookie1,
            headers : {'Host': 'ant.xunsl.com',
                'Referer':'https://ant.xunsl.com/h5/20201020missionSign/?'+jc_cookie1
            },
        }
...
function friendSign(uid,timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://ant.xunsl.com/WebApi/ShareSignNew/sendScoreV2?friend_uid='+uid+'&'+jc_cookie1,
            headers : {'Host': 'ant.xunsl.com',
                'Referer':'https://ant.xunsl.com/h5/20201020missionSign/?'+jc_cookie1
            },
        }
